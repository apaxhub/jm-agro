...
export const metadata: Metadata = {
  title: "JM Agro International | Premium Indian Spices & Agro Commodities",
  description:
    "JM Agro International — FSSAI, HACCP, ISO & KOSHER certified Indian agri exporter from Visnagar, Gujarat. Bulk spices, oil seeds, millets & dehydrated products exported to 11+ countries.",
  keywords: [
  ...
  openGraph: {
    title: "Real Hygiene Pvt. Ltd. | Premium Indian Spices & Agro Commodities",
