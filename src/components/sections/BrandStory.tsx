                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-5 text-muted leading-relaxed text-base">
                            <p>
                                <strong className="text-fg">{siteConfig.brandName}</strong> delivers the purest essence of Indian agricultural produce to global markets.
                            </p>
                            <p>
                                We are based in <strong className="text-fg">{siteConfig.location.city}, {siteConfig.location.state}</strong>, {siteConfig.location.nearBy}. This proximity gives us unmatched sourcing depth, real-time market intelligence, and genuine traceability to farm level.
                            </p>
                            <p>
